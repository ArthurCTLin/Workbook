...
class Snake:
    def __init__(self):
        ...
        for i in range(0, BODY_PARTS):
            self.coordinates.append([0, 0]) #Start from the top left cornor
...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        canvas.delete(snake.squares[-1]) # delete the footprint of snake on canvas
        del snake.squares[-1]
